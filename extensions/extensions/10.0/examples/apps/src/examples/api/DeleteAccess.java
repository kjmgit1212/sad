...
public class DeleteAccess {
	...
	public static String getUsage(String msg) {
		...
		usage.append("\ndeleteAccess: " + msg + "\n");
		usage.append("usage: deleteAccess -[argument] ? \"[value]\"\n");
		usage.append("\n");
		usage.append("-service\tService name which the group is under\n");
		usage.append("-profile\tProfile name of the group\n");
		usage.append("-groupname\tName of the group to clear the access\n");
		usage.append("\n");
		usage
				.append("Example: deleteAccess -service?\"AIX Service\" -profile?\"PosAixGroupProfile\" ");
