...
public class ChangePassword {
	...
	public static boolean run(String args[], boolean verbose) {
		...
		try {
			...
			Collection<AccountMO> accountMOs = new Vector<AccountMO>();
			accountMOs.add(accountMO);
			String password = (String) arguments.get(PASSWORD);
			PasswordManager pManager = new PasswordManager(platform, subject);

			utils.print("Submitting change password request.\n");

			Request request = pManager.changePassword(accountMOs, password,
					null, false);
	...
	public static String getUsage(String msg) {
		...
		usage.append("\nchangePassword: " + msg + "\n");
		usage.append("usage: changePassword -[argument] ? \"[value]\"\n");
		usage.append("\n");
		...
		usage.append("\n");
		usage.append("Example: changePassword -profile?ITIMAccount ");
