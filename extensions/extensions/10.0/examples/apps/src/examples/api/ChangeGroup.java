...
public class ChangeGroup {
	...
	public static String getUsage(String msg) {
		...
		usage.append("\nchangeGroup: " + msg + "\n");
		usage.append("usage: changeGroup -[argument] ? \"[value]\"\n");
		usage.append("\n");
		...
		usage.append("\n");
		usage
				.append("Example: changeGroup -service?\"AIX Service\" -profile?\"PosAixGroupProfile\" ");
		usage.append("-groupname?\"test\" ");
		usage.append("-attribute?\"erPosixGroupIsAdmGrp=true\"");
