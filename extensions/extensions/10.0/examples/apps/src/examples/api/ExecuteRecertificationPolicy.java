...
/**
 * Example purpose: Execute a recertification policy manually.
 */
public class ExecuteRecertificationPolicy {
	...
	public static String getUsage(String msg) {
		...
		usage.append("\nexecuteRecertificationPolicy: " + msg + "\n\n");
		usage.append("usage: executeRecertificationPolicy -[argument] ? \"[value]\"\n");
		usage.append("\n");
		usage.append("-name\tthe name of the recertification policy to execute\n");
		usage.append("");
		usage.append("\n");
		usage.append("Example : executeRecertificationPolicy -name?\"Test Policy Example\"");
