...
/**
* Sample command-line Java class to check if LDAP filter supported.
*/
public class IsFilterSupported {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Submitting request to get filter support info");
            // Submit the request to check if LDAP filter supported
            boolean result = reconManager.isFilterSupported(serviceMO);
            if(result) {
                System.out.println("Filter is supported for the service, during recon.");
            } else {
                System.out.println("Filter is not supported for the service, during recon.");
            }
    ...
    public static boolean printUsage(String msg) {
        ...
        usage.append("\nisFilterSupported: " + msg + "\n");
        usage.append("usage: isFilterSupported -[argument] ? \"[value]\"\n");
        usage.append("\n");
