...
/**
 * Sample command-line Java class to get recon units of a service.
 */
public class GetReconUnits {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Submitting request to get recon units");
            Collection reconDataCollection = 
                                        reconManager.getReconUnits(serviceMO);
            if(reconDataCollection == null || reconDataCollection.isEmpty()) {
                System.out.println("\nNo recon units found");
                System.exit(0);
            }
            System.out.println("\nNumber of recon units found - " + 
                                        reconDataCollection.size());
            for (Iterator it = reconDataCollection.iterator(); it.hasNext();) {

              ReconUnitData reconData = (ReconUnitData)it.next();
              System.out.println("\n\n" + reconData.toString());
    ...
    public static boolean printUsage(String msg) {
        ...
        usage.append("\ngetReconUnits: " + msg + "\n");
        usage.append("usage: getReconUnits -[argument] ? \"[value]\"\n");
        usage.append("\n");
