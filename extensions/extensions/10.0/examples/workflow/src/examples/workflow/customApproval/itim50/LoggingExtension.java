...
public class LoggingExtension implements ScriptExtension {
	...
	public void initialize(ScriptInterface si, ScriptContextDAO dao)
		...
		ContextItem logFunc = ContextItem.createGlobalFunction("log",
				new LogFunction());
		allItems.add(logFunc);
	}
	 ...
	 */
	public class LogFunction implements GlobalFunction {
		...
		public Object call(Object[] parameters)
			...
			logger.logInformation(this, parameters[0].toString());
