...
<html>
	...
	<head>
		...
		<title>Tivoli Identity Products Integration Sample - Applications Subscription Submitted</title>
	</head>
			...
			<tr>
				...
				<td width="100%">
					...
					<table border=0 cellpadding=0 cellspacing=0 width=100%>
						...
						<tr>
							<td class="text-description">Your applications subscription changes
							have been successfully submitted.</td>
						</tr>
					</table>
